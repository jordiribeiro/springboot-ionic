package com.jordiribeiro.cursomc.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> ahuthorization(AuthorizationException e,HttpServletRequest request){
